  ...
  minus_adult.forEach((btn) => {
    btn.addEventListener("click", () => {
      if (input_adult.value > 1) {
        ...
        input_adult.value = 1; // Устанавливаем минимальное значение для кол-ва взрослых
      }
    });
  });
